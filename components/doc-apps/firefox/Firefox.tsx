    ...
    return (
        <ContextMenu>
            <ContextMenuTrigger>
                ...
                }} className={twMerge('w-[70%] h-[80%] absolute top-[75px] left-[200px] select-none rounded-xl overflow-hidden min_max_transition flex flex-col border border-[#ececec] dark:border-[#0e0e0e] duration-300', activeWindow === id && ' z-10', fullScreen && '!top-0 !left-0 !w-full !h-full !transform-none !rounded-none')} ref={windowRef} onClick={() => setActiveWindow(id)}>
