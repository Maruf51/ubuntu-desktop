...
import { useMetaDataStore } from "@/store/useStore"
...
>(({ className, ...props }, ref) => {
  return (
    <SliderPrimitive.Root
      ...
      {...props}
    >
      <SliderPrimitive.Track className="relative h-1.5 w-full grow overflow-hidden rounded-full dark:bg-[#484848] bg-[#d4d4d4] duration-300">
